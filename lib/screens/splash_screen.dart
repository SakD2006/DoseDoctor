...
import 'home/home_screen.dart'; // Make sure HomeScreen is implemented
...
class _SplashScreenState extends State<SplashScreen>
  ...
  Widget build(BuildContext context) {
    // For landscape, ensure that SystemChrome settings in main.dart and/or
    // platform-specific configurations (Info.plist / AndroidManifest.xml) are set.
    return Scaffold(
      body: FadeTransition(
